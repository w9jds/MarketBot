...
//    @NonNull
//    @Override
//    public ItemHolderInfo recordPreLayoutInformation(RecyclerView.State state, RecyclerView.ViewHolder viewHolder,
...
//
//        if (preInfo instanceof DesignerNewsItemHolderInfo && ((DesignerNewsItemHolderInfo) preInfo).animateAddToPocket) {
//
//            final FeedAdapter.DesignerNewsStoryHolder holder = (FeedAdapter.DesignerNewsStoryHolder) newHolder;
//
//            // setup for anim
...
//
//            Animator pocketMoveUp = ObjectAnimator.ofFloat(holder.pocket, View.TRANSLATION_X, View.TRANSLATION_Y,
...
//                    PropertyValuesHolder.ofFloat(View.SCALE_X, 3f), PropertyValuesHolder.ofFloat(View.SCALE_Y, 3f));
...
//                    View.TRANSLATION_X, View.TRANSLATION_Y, arc.getPath(translatedLeft, translatedTop, 0, 0));
...
//            ObjectAnimator pocketFadeDown = ObjectAnimator.ofInt(holder.pocket, ViewUtils.IMAGE_ALPHA, 138);
//
